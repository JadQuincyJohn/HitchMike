...
- (IBAction) pushDriverDetailViewController:(id)sender{
    DriverDetailViewController * driverDetailViewController = [[[DriverDetailViewController alloc] initWithNibName:NSStringFromClass([DriverDetailViewController class]) bundle:nil andModel:self.model] autorelease];
...
- (IBAction) pushOnTheGoViewController:(id)sender{
    OnthegoViewController * onthegoViewController = [[[OnthegoViewController alloc] initWithNibName:NSStringFromClass([OnthegoViewController class]) bundle:nil andModel:self.model] autorelease];
